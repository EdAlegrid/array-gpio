...
read (pin)
{
	//console.log('read_pin_status');
	return cc.gpio_read(convertPin(pin));
}

enable_async_rising_pin_event(pin)
{
	//console.log('enable_async_rising_event');
	cc.gpio_enable_async_rising_event(convertPin(pin), 1); 
}

detect_input_pin_event(pin)
{
	//console.log('detect_pin_event');
	return cc.gpio_detect_input_event(convertPin(pin));
}

reset_all_pin_events(pin)
{
	//console.log('reset_all_pin_events');
	cc.gpio_reset_all_events(convertPin(pin));
}

reset_pin_event(pin)
{
	//console.log('reset_pin_event');
